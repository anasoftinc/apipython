...
namespace ApiNCorePyWrApplication1.Entity.UnitofWork
{
    ...
    public interface IUnitOfWork : IDisposable
    {
        ...
        ApiNCorePyWrApplication1Context Context { get; }
        bool Save();
        Task<bool> SaveAsync();
    }
    ...
    {
        public ApiNCorePyWrApplication1Context Context { get; }

        private Dictionary<Type, object> _repositoriesAsync;
        private Dictionary<Type, object> _repositories;
        private bool _disposed;

        public UnitOfWork(ApiNCorePyWrApplication1Context context)
        {
            Context = context;
            _disposed = false;
        }
